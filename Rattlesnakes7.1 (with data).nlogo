...
## HOW IT WORKS
--Settings--
The settings are set to create an area of 40 by 30 patches. Each patch represents one mile, creating a total area of 1,200 square miles. This is approximately the area of the southwest corner of Chaves County.

--SETUP--
The setup button creates the setup of the rattlesnake's world. The world is set to have a sandy color. Snakes and hunters are created. The beginning number of snakes and hunters are determined by the slider found on the interface. 90% of the snakes will be adult snakes (sexually mature) while the other 10% will be baby snakes (not sexually mature).

***Note:*** The most realistic beginning snake number is 72,000. This was determined by research suggesting there were 60 snakes per square mile. Multiplying 60 by the total area of 1,200 gives 72,000 snakes.

Each snake is given a random snake length value based on analyzed statistics of raw snake data. This is done by using NetLogo's 'random-normal' function, enabling a realistic snake length distribution.
The age of each snake is determined based on their snake lengths. Baby snakes are born at around 228 to 343 millimeters and are sexually mature at 3 years old (estimated to be around 516 mm). So their age is determined by subtracing a snake's length by their birth length (228) and dividing it by 96 (slope of how much they have to grow per year in 3 years to reach sexual maturity of 516mm). Adult snakes go through a similar process. Their age is determined by dividing the snake's length by 73 (slope of how much they have to grow per year in 17 years to reach maximum snake length found in raw data (1765mm)).
...
Raw data gathered by the late New Mexico state herpetologist Charles W. Painter was used in order to create real-life inputs and elements for this model.
@#$#@#$#@
default
true
0
